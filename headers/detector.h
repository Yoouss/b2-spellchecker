 ...
 * @param  dict un pointeur vers des dictionaire de type Dictionary_t
 * @return si vrai returne 1 si c'est faux on retourne 0 et -1 si erreur
 */
int word_in_dictionary(char* word, Dictionary_t* dicts);
 ...
 */
int* words_in_line(char* line, int lenght, Dictionary_t* dicts);
